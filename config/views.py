...
def dashboard(request):
    ...
    context = {
        'salon': salon,
        'form': form, 's_form': s_form, 'h_form': h_form,
        'services': salon.services.all(), # Lista de servicios
...
def employee_dashboard(request):
        ...
        if 'update_keys' in request.POST:
            ...
            if schedule_form.is_valid():
                EmployeeSchedule.objects.update_or_create(
                    employee=employee, weekday=schedule_form.cleaned_data['weekday'],
    ...
    return render(request, 'dashboard/employee_dashboard.html', {
        ...
        'settings_form': settings_form, 'schedule_form': schedule_form
    })
