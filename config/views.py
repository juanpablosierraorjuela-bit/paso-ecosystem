...
# --- IMPORTACIONES CORRECTAS (NO TOCAR) ---
...
def home(request):
    ...
    # Obtenemos ciudades únicas para el filtro
...
def dashboard(request):
    # Seguridad: Evitar que empleados/clientes entren aquí
    ...
    try:
        ...
        # Si no tiene salón, mostrar formulario de creación
        if request.method == 'POST':
