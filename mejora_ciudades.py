...
print("🇨🇴 Iniciando Estandarización de Ciudades Colombianas...")
...
CIUDADES_COLOMBIA = [
    ...
    ('Duitama', 'Duitama'), ('Sogamoso', 'Sogamoso'), ('Paipa', 'Paipa'), # Agregadas de Boyacá
...
try:
    ...
    print("✅ forms.py actualizado: Ahora los dueños verán una lista desplegable.")
