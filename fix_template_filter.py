...
# ==========================================
# CONTENIDO CORREGIDO (BOOKING WIZARD)
# ==========================================
# Quitamos el filtro floatform por ahora y usamos int() en la vista o formato simple
# Ojo: floatform debería funcionar, pero a veces da guerra si no se carga 'humanize'.
# Vamos a usar una solución segura: quitar el filtro en el HTML y asegurarnos de que la vista mande un entero.
...
# ==========================================
# TAMBIÉN ASEGUREMOS QUE LA VISTA MANDE UN ENTERO
# ==========================================
marketplace_views_update = """
...
def apply_fix():
    print("🚑 ARREGLANDO ERROR DE FILTRO EN TEMPLATE...")
    
    # 1. Template
    with open(BASE_DIR / 'templates' / 'marketplace' / 'booking_wizard.html', 'w', encoding='utf-8') as f:
        f.write(html_wizard_fixed.strip())
    print("✅ Template corregido (floatform eliminado).")

    # 2. Views
    with open(BASE_DIR / 'apps' / 'marketplace' / 'views.py', 'w', encoding='utf-8') as f:
        f.write(marketplace_views_update.strip())
    print("✅ View actualizada (Enviando monto como entero).")

if __name__ == "__main__":
    apply_fix()
    print("\n🚀 LISTO. El error 500 debe haber desaparecido.")